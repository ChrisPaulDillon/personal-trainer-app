...
export const metadata = {
  title: "Fitness Blog | Chris Dillon Fitness",
  description:
    "Read the latest fitness tips, nutrition advice, and training strategies from Glasgow's top personal trainer.",
};
...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      "Stuck at the same weights for weeks? Discover proven techniques to overcome plateaus and continue making progress in your training.",
    date: "March 22, 2025",
    category: "Strength Training",
    author: "Chris Dillon Fitness",
  ...
  },
  {
    ...
    excerpt:
      "Learn why progressive overload is the fundamental principle behind all successful training programs and how to implement it effectively.",
    date: "March 15, 2025",
    category: "Training",
    author: "Chris Dillon Fitness",
  ...
  },
  {
    ...
    excerpt:
      "Optimize your performance with the right pre-workout meal timing and composition based on your training goals and preferences.",
    date: "March 8, 2025",
    category: "Nutrition",
    author: "Chris Dillon Fitness",
    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      ...
      <div className="mt-12 text-center">
        <p className="text-muted-foreground">
          Subscribe to our newsletter to receive the latest fitness articles in
          your inbox.
        </p>
