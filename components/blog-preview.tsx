    ...
    <section ref={ref} className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <p className="text-sm font-medium text-primary uppercase tracking-wider">Articles & Insights</p>
          <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">Latest From The Blog</h2>
          <p className="text-muted-foreground text-lg">
            Fitness tips, nutrition advice, and evidence-based strategies to help you
